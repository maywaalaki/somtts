...
def process_text_with_groq(text):
    instruction = "You are a Somali TTS text processor. Rewrite the input text so it can be read naturally by a Somali voice. Convert symbols to Somali words (e.g., @ to 'at', $ to 'doolar', % to 'boqolkiiba'). Output only the processed text."
