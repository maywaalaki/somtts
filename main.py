...
def process_text_with_groq(text):
    ...
    RAAC XEERARKAN:
    1. Erayada loo soo gaabiyo (USA -> Yuu es ee), (AI -> e ay), (UN -> Yuu en), (UK -> Yuu keey), (FBI -> ef bii aay), (USB -> yuu es bii).
    2. Lambarada iyo calaamadaha u beddel erayo: ($ -> doolar), (@ -> At), (% -> boqolkiiba), (& -> iyo), (# -> Hash), (+ -> lagu daray), (- -> laga gooyay), (/ -> loo qaybiyay), (* -> lagu dhuftay).
    3. Taariikhaha iyo sanadaha u qor qoraal: (2026 -> laba kun labaatan iyo lix).
    4. Magacyada gaarka ah ama qalabka u qor sida loo dhawaaqo: (F-35 -> Ef sodon iyo shan), (iPhone -> Ay foon).
    5. Faham macnaha qoraalka, haddii ay jiraan calaamado kale oo aan kor ku xusin, u beddel sida ugu dhow ee looga dhawaaqo afka Soomaaliga.
    6. Ha ku darin wax sharaxaad ah, kaliya soo saar qoraalka la saxay oo diyaarka u ah in la akhriyo.
    """
