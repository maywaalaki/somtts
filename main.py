...
def create_voice_keyboard():
    ...
    keyboard.add(KeyboardButton("Ubax 👩🏻‍🦳"), KeyboardButton("Codka Qulaasada 😜"), KeyboardButton("Muuse 👨🏻‍🦱"))
    return keyboard
...
@bot.message_handler(func=lambda m: m.text in ["Ubax 👩🏻‍🦳", "Muuse 👨🏻‍🦱", "Codka Qulaasada 😜"])
def set_voice(message):
    ...
    elif "Qulaasada" in choice:
        voice_data = {"name": "so-SO-MuuseNeural", "label": "Codka Qulaasada 😜"}
    else:
