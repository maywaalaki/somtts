...
EN_TO_SO_FULL = {
    "a": "ee", "b": "bii", "c": "sii", "d": "dii", "e": "ii", "f": "ef", "g": "jii",
    "h": "eyj", "i": "ay", "j": "jey", "k": "key", "l": "el", "m": "em", "n": "en",
    "o": "ow", "p": "pii", "q": "kiyu", "r": "aar", "s": "es", "t": "tii", "u": "yu",
    "v": "vii", "w": "dhabal yu", "x": "eks", "y": "way", "z": "sii",
    "A": "ee", "B": "bii", "C": "sii", "D": "dii", "E": "ii", "F": "ef", "G": "jii",
    "H": "eyj", "I": "ay", "J": "jey", "K": "key", "L": "el", "M": "em", "N": "en",
    "O": "ow", "P": "pii", "Q": "kiyu", "R": "aar", "S": "es", "T": "tii", "U": "yu",
    "V": "vii", "W": "dhabal yu", "X": "eks", "Y": "way", "Z": "sii",
    ...
    ".": "dot", ",": "comma", "?": "question", "!": "exclamation", ":": "colon",
    ";": "semicolon", "-": "hyphen", "_": "underscore", "\"": "double_quote", "'": "single_quote",
    "(": "open_paren", ")": "close_paren", "[": "open_bracket", "]": "close_bracket",
    "{": "open_brace", "}": "close_brace", "/": "slash", "\\": "backslash", "@": "at",
    "#": "hash", "$": "doolar", "€": "yuuro", "£": "bownd", "%": "boqolkiiba",
    "&": "and", "*": "asterisk", "+": "plus", "=": "equals", "<": "less_than", ">": "greater_than",
    "^": "caret", "~": "tilde", "`": "backtick", "|": "pipe"
}
...
def replace_numbers_with_words(text: str) -> str:
    ...
    processed_text = []
    for char in text:
        if char in EN_TO_SO_FULL and not char.isalnum():
            processed_text.append(" " + EN_TO_SO_FULL[char] + " ")
        else:
